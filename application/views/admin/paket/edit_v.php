            ...
            <form id="form" method="post">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <select name="id_pelayanan" id="id_pelayanan" class="form-control">
                                ...
                                <option <?php if ($pelayanan->id == $id_pelayanan) {echo "selected";}?> value="<?php echo $pelayanan->id ?>"><?php echo $pelayanan->name ?></option>
                                <?php }?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control" value="<?php echo $name; ?>" type="text" id="name" name="name" autocomplete="off" required placeholder="Nama Paket">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="form-label col-sm-3" for="">Harga</label>
                        <div class="col-sm-4">
                            <input class="form-control" type="number" id="harga" name="harga" autocomplete="off" required placeholder="Harga" value="<?php echo $harga ?>">
                        </div>
                    </div>
                    <div class="form-group row">
